...
<?php if ($show_this_block == "Yes") { ?>
    <div class="fullwidth vdocontent-sec">
        <div class="wrapper">
            <div class="vdocontent-inn fl">
                <div class="vdocontent-lf">
                    <div class="vdocontent-img bgimg" style="background-image: url('<?php echo $bg_image; ?>');">
                        <div class="about-vdo">
                            <span class="play-icon"><img src="<?php echo site_url() ?>/wp-content/themes/diaan/assets/images/play-icon.svg"></span>
                ...
                <div class="vdocontent-rght">
                    <div class="vdocontent">
                        <div class="sectag"><?php echo $title; ?></div>
                        <h2><?php echo $header; ?></h2>
                        <div class="vdocontent-txt list-icon">
                            <?php echo $content; ?>
                        </div>
                        <?php if ($discover_button != "") { ?>
                            <div class="button secbtn fl black-btn">
        ...
        <div class="shape-img">
            <img src="<?php echo site_url() ?>/wp-content/themes/diaan/assets/images/shape1.png" class="rght-img">
        </div>
    </div>
<?php } ?>